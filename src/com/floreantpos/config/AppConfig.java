...
public class AppConfig {
	...
	public static String getConnectString() {
		return config.getString(CONNECTION_STRING, Database.POSTGRES.getConnectString("", "", ""));  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	}
	...
	public static String getDatabaseProviderName() {
		return config.getString(DATABASE_PROVIDER_NAME, Database.POSTGRES.getProviderName()); //$NON-NLS-1$
	}
