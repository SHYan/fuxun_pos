...
public class StockAdjustReportView extends JPanel {
	...
	public StockAdjustReportView() {
		...
		categoryListBox.setModel(new ListComboBoxModel(Arrays.asList("All", "Procurement",  "Inventory", "Demage", "Others")));
	...
	private void viewReport() throws Exception {
		...
		else map.put("transactionType", categoryListBox.getSelectedItem().toString());
		//if(cbZeroStock.isSelected())
			//map.put("stockAmount", 0);
		
		List<MenuItemM> dataSource = IBatisFactory.selectList("Report.getProduct_Stock_Adjust", map);
