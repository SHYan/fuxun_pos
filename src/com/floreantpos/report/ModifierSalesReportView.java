...
public class ModifierSalesReportView extends JPanel {
	Log logger = LogFactory.getLog(ModifierSalesReportView.class);
	...
	public ModifierSalesReportView() {
		...
		btnGo.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					POSMessageDialog.showError(ModifierSalesReportView.this, POSConstants.ERROR_MESSAGE, e1);
				}
			}
	...
	private void viewReport() throws Exception {
		...
		List<ProductSalesM> dataSource = IBatisFactory.selectList("Report.getModifier_Sales", map);
		String reportTemplate = "modifier_sales_report";
		if(cbPrintType.getSelectedItem().toString().equals("80mm"))
			reportTemplate = "modifier_sales_report_80mm";
