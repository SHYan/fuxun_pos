...
public class InventoryVendorDAO extends BaseInventoryVendorDAO {
	...
	public boolean exists(String vendorName) throws PosException {
		Session session = null;
		
		try {
			session = createNewSession();
			Criteria criteria = session.createCriteria(getReferenceClass());
			criteria.add(Restrictions.eq(InventoryVendor.PROP_NAME, vendorName));
	...
	public void refresh(InventoryVendor vendor) throws PosException {
		Session session = null;
