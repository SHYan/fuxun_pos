...
public class UserPermission extends BaseUserPermission {
	...
	//Diana
	public final static UserPermission VIEW_INVENTORY = new UserPermission("View Inventory", "View_Inventory");
	//Diana - 2018-08-03 for merge ticket 
	public final static UserPermission MERGE_TICKET = new UserPermission("Merge Ticket", "Merge_Ticket"); //$NON-NLS-1$ //$NON-NLS-2$
	public final static UserPermission TRUNCATE_DATA = new UserPermission("Truncate Data", "Truncate_Data"); 	
	
	public final static UserPermission BILL_PAYMENT = new UserPermission("Bill Payment", "Bill_Payment");
	public final static UserPermission RETURN_ITEM = new UserPermission("Return Item", "Return_Item");
	public final static UserPermission REPORT_PRODUCT_RETURN = new UserPermission("Product Return Report", "Report_Product_Return");
	public final static UserPermission REPORT_ORDER_STATUS = new UserPermission("Order Status Report", "Report_Order_Status");
	...
	public final static UserPermission[] permissions = new UserPermission[] { VIEW_ALL_OPEN_TICKETS, VIEW_ALL_CLOSE_TICKETS, CREATE_TICKET, VOID_TICKET, RETURN_ITEM,
		AUTHORIZE_TICKETS, SPLIT_TICKET, MERGE_TICKET, SETTLE_TICKET, REOPEN_TICKET, TRANSFER_TICKET, MODIFY_PRINTED_TICKET, HOLD_TICKET, BILL_PAYMENT,
		VIEW_BACK_OFFICE, PAY_OUT, DRAWER_ASSIGNMENT, DRAWER_PULL, VIEW_EXPLORERS, VIEW_REPORTS, REPORT_PRODUCT_RETURN, REPORT_ORDER_STATUS, ADD_DISCOUNT, REFUND, PERFORM_MANAGER_TASK, 
		PERFORM_ADMINISTRATIVE_TASK, MANAGE_TABLE_LAYOUT, TABLE_BOOKING, KITCHEN_DISPLAY, ALL_FUNCTIONS, QUICK_MAINTENANCE, VIEW_INVENTORY,TRUNCATE_DATA,
		SHUT_DOWN};
